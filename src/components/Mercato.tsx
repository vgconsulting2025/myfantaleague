...
import type { EnrichedProposal, LeaguePlayer, TradeRecord } from "@/lib/league/types";
import { ErrorBox, RoleBadge, SectionTitle, Spinner } from "./ui";
import { timeAgo } from "./format";

function PlayerChip({ player, label }: { player: LeaguePlayer | null; label: string }) {
  return (
    <div>
            ...
            return (
              ...
              >
                <div className="grid grid-cols-1 items-center gap-3 sm:grid-cols-[1fr_auto_1fr]">
                  <PlayerChip player={p.givePlayer} label="Cedi" />
                  <div className="text-center font-display text-2xl text-emerald-600">⇄</div>
                  <PlayerChip player={p.receivePlayer} label="Ricevi" />
                </div>
